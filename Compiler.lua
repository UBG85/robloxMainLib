...
luaP.OpMode = { iABC = 0, iABx = 1, iAsBx = 2 } luaP.SIZE_C  = 9
luaP.SIZE_B  = 9
...
local function opmode(t, a, b, c, m)local luaP = luaP return t * 128 + a * 64 + luaP.OpArgMask[b] * 16 + luaP.OpArgMask[c] * 4 + luaP.OpMode[m]end
...
return function(a) return luaK end
